...
object ExceptionsMessages {
    ...
    const val EMPTY_CURRENT_WEATHER = "Ошибка получения названия города"
    const val EMPTY_WEATHER = "Ошибка получения данных о погоде"
    const val EMPTY_TEMP = "Ошибка получения температуры"
    const val EMPTY_FEELS_LIKE = "Ошибка получения температуры по ощущениям"
    const val EMPTY_PRESSURE = "Ошибка получения давления"
