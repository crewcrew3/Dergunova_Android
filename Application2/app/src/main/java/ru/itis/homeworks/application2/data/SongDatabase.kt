...
object SongDatabase {
    ...
    val songs: List<MultipleHolderData> = listOf(
        SongHolderData (
            id = 1,
            name = "Dramaturgy",
            lyrics = "Bokura ima saa saa kurai ate\n" +
        ...
        SongHolderData (
            id = 2,
            name = "Last Dance",
            lyrics = "Shinki wo matotta shounen shoujo\n" +
        ...
        SongHolderData (
            id = 3,
            name = "Fight Song",
            lyrics = "Yoru wa mada akenu mama\n" +
                    "Yume wo miyou\n" +
                    "\n" +
                    "Boku ni datte nyee\n" +
                    "Mirai ni kaketeike\n" +
        ...
        SongHolderData(
            id = 4,
            name = "Insomnia",
            lyrics = "Kishi kaisei sou saigo da banjou no itte\n" +
        ...
        SongHolderData (
            id = 5,
            name = "Harpy Hare",
            lyrics = "All the arrows that you've stolen\n" +
        ...
        SongHolderData (
            ...
            lyrics = "Zankoku na tenshi no you ni\n" +
        ...
        SongHolderData (
            ...
            lyrics = "Wah-hah-hah-hah~!\n" +
                    ...
                    "Kedo ichiban migi no za еgao nashi\n" +
                    "\n" +
                    "Oh baby\n" +
                    "Tada waratte kure\n" +
        ...
        SongHolderData (
            id = 9,
            name = "Killer Queen",
            lyrics = "She keeps Moët et Chandon\n" +
